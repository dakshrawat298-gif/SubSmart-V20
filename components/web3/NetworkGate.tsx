 ...
 * already supported. Rendered via Portal so the overlay always sits above all
  ...
  return (
    <Portal>
      ...
      >
        ...
        <div className="relative z-[91] w-full max-w-md overflow-hidden rounded-3xl border border-white/10 bg-[#0d1228] shadow-[0_30px_120px_-20px_rgba(244,114,182,0.35)]">
