    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 py-4 sm:px-8 sm:py-6">
        <div className="flex items-center gap-2">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-fuchsia-500 text-white shadow-[0_8px_24px_-8px_rgba(168,85,247,0.7)]">
            <svg
              viewBox="0 0 24 24"
              className="h-5 w-5"
              fill="none"
      ...
      <main className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-4 pb-20 pt-10 text-center sm:px-6 sm:pt-20">
        ...
        <div className="mt-8 flex w-full flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <a
            href="#"
            className="inline-flex h-11 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] px-5 text-sm text-white/80 transition hover:border-white/20 hover:bg-white/[0.06] focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300 sm:h-12 sm:px-6 sm:text-base"
          >
            Read the docs
          </a>
        </div>
